...
var FollowerListComponent = (function () {
    function FollowerListComponent(userService, route) {
    ...
    FollowerListComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (routeParams) {
            ...
            _this.listProvider = function (params) {
                return _this.userService.listFollowers(_this.userId, params);
            };
        });
    };
...
var follower_list_component_1 = __webpack_require__(1373);
var ng_module_1 = __webpack_require__(33);
var router_1 = __webpack_require__(32);
var routes = [
    { path: '', component: follower_list_component_1.FollowerListComponent },
];
var FollowerListModule = (function () {
    function FollowerListModule() {
    }
    FollowerListModule = __decorate([
        ng_module_1.NgModule({
            imports: [
                common_1.CommonModule,
            ...
            declarations: [
                follower_list_component_1.FollowerListComponent,
            ],
            exports: [
                follower_list_component_1.FollowerListComponent,
            ]
    ...
    return FollowerListModule;
}());
exports.FollowerListModule = FollowerListModule;
