...
describe('UserEditComponent', () => {
  ...
  const user: User = {id: 1, email: "test@test.com", name: "test user", fname: "yyyyyyyyyyyy"};
  ...
  it('can be shown', () => {
    ...
    const fnameInput = <HTMLInputElement>getDOM().querySelector(el, '#fnameInput');
    expect(fnameInput.value).toEqual('yyyyyyyyyyyy');
  ...
  it('can validate inputs', () => {
    ...
    cmp.fname.setValue('yyyyyyyyyyyy');    
