...
describe('MicropostListComponent', () => {
  ...
  it('can show list of posts', () => {
    ...
    expect(cmp.posts.length).toEqual(7);

    const el = cmpDebugElement.nativeElement;
    
    expect(getDOM().querySelectorAll(el, 'li>.content').length).toEqual(14);

    console.log(getDOM().querySelectorAll(el, 'li>.content'));
    
    const content = getDOM().querySelector(el, '.content');
    console.log(content.innerHTML);
    expect(content.innerHTML).toEqual('Title : title1');
   ...
   console.log('Can load more test');
   console.log(getDOM().querySelector(cmpDebugElement.nativeElement, '.moreBtn'));
  ...
  it('can load more', () => {
    ...
    console.log(getDOM().querySelector(cmpDebugElement.nativeElement, '.moreBtn'));
    moreBtn.click();
    expect(cmp.posts.length).toEqual(14);
  });
  ...
  it('deletes micropost when confirmed', () => {
    ...
    deleteLink.click();
    expect(cmp.posts.length).toEqual(13);
  });
